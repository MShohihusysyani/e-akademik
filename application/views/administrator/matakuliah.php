<div class="container-fluid">
    ...
    <?php echo anchor('administrator/matakuliah/tambah_matakuliah',' <button class="btn  btn-primary mb-3"><i class="fas fa-plus"></i></button>')?>
     ...
     <tr style="background-color:#c9d3ff; text-align:center;">
        ...
        <?php
            ...
            <tr class="text-center">
                ...
                <td width="20px"><?php echo anchor('administrator/matakuliah/update/'.$mk->kode_matakuliah,'<div class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></div>')?></td>
