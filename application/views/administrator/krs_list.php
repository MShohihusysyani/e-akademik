...
<div class = "alert alert-warning" role="alert">
    ...
    <?php echo anchor('administrator/krs/tambah_krs/'.$nim.'/'.$id_thn_akad,' <button class="btn btn-primary mb-3"><i class="fas fa-plus "></i></button>')?>
            ...
            <tr style="background-color:#c9d3ff; text-align:center;">
             ...
             <?php
                    ...
                    <tr class="text-center">
                        ...
                        <td width="20px"><?php echo anchor('administrator/krs/update/'.$krs->id_krs,'<div class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></div>')?></td>
    ...
    <?php echo anchor('administrator/krs','<div class="btn  btn-primary">Kembali</div>')?><br>
</div>