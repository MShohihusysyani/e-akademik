                ...
                <div class="modal-body">
                 <div class="row">
                    <div class="col-md-3 text-success text-center">
                        <a href="<?php echo base_url('dosen/matakuliah') ?> "> <p class="nav-link small text-success">MATA KULIAH </p></a>
                        <i class="fas fa-3x fa-book"></i>
                    </div>

                    <div class="col-md-3 text-success text-center">
                        <a href="<?php echo base_url('dosen/nilai/input_nilai') ?> "> <p class="nav-link small text-success">INPUT NILAI </p></a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="<?php echo base_url('dosen/auth/logout')?>">Logout</a>
                </div>
            </div>
        </div>
    </div>
