...
class Matakuliah extends CI_Controller{
   ...
   public function tambah_matakuliah(){
    ...
    $this->load->view('templates_dosen/header');
    $this->load->view('templates_dosen/sidebar');
    $this->load->view('dosen/matakuliah_form', $data);
    $this->load->view('templates_dosen/footer');
}
public function tambah_matakuliah_aksi(){
    ...
    if($this->form_validation->run() == FALSE){
        ...
        #Sweet Alert
        $this->session->set_flashdata('pesan','<div class="swal-matkul-input" data-swal-matkul-input="<?= session()->get("pesan");?></div>');
        redirect('dosen/matakuliah');
...
public function _rules(){
    ...
    $this->form_validation->set_rules('sks','sks','required',['required'                         => 'Kode Mata Kuliah Wajib Diisi!']);
...
public function detail($kode){
    ...
    $this->load->view('templates_dosen/header');
    $this->load->view('templates_dosen/sidebar');
    $this->load->view('dosen/matakuliah_detail', $data);
    $this->load->view('templates_dosen/footer');
    ...
    public function update($id){
        ...
        $this->load->view('templates_dosen/header');
        $this->load->view('templates_dosen/sidebar');
        $this->load->view('dosen/matakuliah_update', $data);
        $this->load->view('templates_dosen/footer');
    }
    ...
    public function update_aksi(){
        ...
        $this->prodi_model->update_data($where,$data,'matakuliah');
        //SWEET ALERT
        $this->session->set_flashdata('pesan','<div class="swal-update-matkul" data-swal-update-matkul="<?= session()->get("pesan");?></div>');
        redirect('dosen/matakuliah');
    ...
    public function delete($id){
        ...
        //Sweet Alert
            $this->session->set_flashdata('pesan','<div class="swal-delete-matkul" data-swal-delete-matkul="<?= session()->get("pesan"); onclick="delete(<?php echo $id?>); "?></div>');
        redirect('dosen/matakuliah');
    }
}
