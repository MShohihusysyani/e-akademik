...
class Prodi extends CI_Controller{
    ...
    public function tambah_prodi_aksi(){
        ...
        if($this->form_validation->run() == FALSE){
            ...
            $this->session->set_flashdata('pesan','<div class="swal-prodi" data-swal-prodi="<?= session()->get("pesan");?></div>');
    ...
    public function update_aksi(){
        ...
        $this->session->set_flashdata('pesan','<div class="swal-prodi-update" data-swal-prodi-update="<?= session()->get("pesan");?></div>');
        redirect('administrator/prodi');
    }
    public function delete($id){
        ...
        $this->session->set_flashdata('pesan','<div class="swal-delete-prodi" data-swal-delete-prodi="<?= session()->get("pesan"); onclick="delete(<?php echo $id?>); "?></div>');
        redirect('administrator/prodi');
    }
}